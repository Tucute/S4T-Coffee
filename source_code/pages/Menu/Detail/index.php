                ...
                <div class="form-product">
                    ...
                    <div class="btn-buy">
                        <button class="btn btn-danger">
                            <a href="http://localhost/Project_PHP/source_code/pages/Menu/Detail/function.php?amount=<?php echo $amount ?>">
                        ...
                        <button class="btn btn-danger">
                            <a href="http://localhost/Project_PHP/source_code/pages/Menu/Payment/">Mua ngay</a>
                        </button>
                    </div>
                </div>
            </div>
